...
<div id="layout" class="pure-g">
        ...
        <div class="header">
            ...
            <nav class="nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a class="pure-button" href="http://yuilibrary.com">Post</a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <div class="content pure-u-1 pure-u-md-3-4">
        <div>
            ...
            <div class="posts">
                <h1 class="content-subhead">Fecha</h1>
                ...
                <section class="post">
                    <header class="post-header">
                        ...
                        <p class="post-meta">
                            Por <a href="#" class="post-author">esneyder</a> Categoria <a class="post-category post-category-design" href="#">CSS</a>  
                        </p>
                    </header>
